...
cmake -DDPCPP_HOME=<path-to-sycl-workspace> -DLIBTORCH_INSTALL_ROOT=<path-to-libtorch-install> -DOPENCV_INSTALL_ROOT=<path-to-opencv-install> 

-DONEDNN_INSTALL=<path-to-onednn-install> -DUSE_CUDA_BACKEND=<{True | False}> ..
